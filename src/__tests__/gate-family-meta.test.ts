...
export const KNOWN_THRESHOLD_SITES: readonly string[] = [
  ...
  "scripts/mutation-runner/run.mjs :: FILES_FLOOR=9", //            coverage ratchet: MEASURED + 2026-09-03 (second FILE move, plan 164.4-05)
  "scripts/mutation-runner/run.mjs :: ARMS_FLOOR=134", //           biting ratchet: MEASURED + 2026-09-03 (re-derived, plan 164.4-05)

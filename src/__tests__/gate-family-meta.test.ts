...
export const KNOWN_THRESHOLD_SITES: readonly string[] = [
  ...
  "scripts/mutation-runner/run.mjs :: FILES_FLOOR=4", //            coverage ratchet: MEASURED + 2026-09-03 (first FILE move)
  "scripts/mutation-runner/run.mjs :: ARMS_FLOOR=86", //            biting ratchet: MEASURED + 2026-09-03 (re-derived)

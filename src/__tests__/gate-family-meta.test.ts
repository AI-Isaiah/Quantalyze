...
export const KNOWN_THRESHOLD_SITES: readonly string[] = [
  ...
  "scripts/mutation-runner/run.mjs :: FILES_FLOOR=13", //           coverage ratchet: MEASURED + 2026-09-03 (third FILE move, plan 164.4-06)
  "scripts/mutation-runner/run.mjs :: ARMS_FLOOR=163", //           biting ratchet: MEASURED + 2026-09-03 (re-derived, plan 164.4-06)

...
export default async function AdminPage() {
  ...
  const [introRequests, pendingStrategies, pendingAllocators] = await Promise.all([
    admin
      ...
      .select("id, status, message, created_at, allocator_id, strategy_id, profiles!contact_requests_allocator_id_fkey(display_name, company), strategies!contact_requests_strategy_id_fkey(name)")

...
/**
 * Phase 14a — Panel 2 segmented control.
 *
 ...
 * focusable for screen-reader announcement of "Available in Phase 14b" per
 * UI-SPEC §8) and short-circuit click handlers via `e.preventDefault()`.
 *
 * Active button: 1px accent border + accent-color label (UI-SPEC §3
 * "Active button styling: bg-card border border-accent text-accent").

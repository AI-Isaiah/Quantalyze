...
export function PortfolioEquityCurve({ portfolioEquityCurve, strategies }: PortfolioEquityCurveProps) {
  ...
  useEffect(() => {
    ...
    // Portfolio composite line (thick, always on top)
  ...
  }, [portfolioEquityCurve, strategies, mode]);

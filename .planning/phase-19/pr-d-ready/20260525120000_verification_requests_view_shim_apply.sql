...
--
-- ⚠️  GATE: DO NOT SHIP until the 168h soak is genuinely green. As of
-- 2026-05-25 the kill-switch (feature_flags.process_key_unified_backbone) is
-- 'off', flag_flipped_at is unrecorded, and the soak has NOT started. See

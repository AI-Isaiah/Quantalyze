...
- [x] 164.5-06-PLAN.md — crit 3 / DRIFT-04: pre-flight with three measurement-printing assertions, the exact-signature `DROP FUNCTION`, three reviewers and a founder apply gate, then regenerate `database.types.ts` (wave 2, not autonomous)

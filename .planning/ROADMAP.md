...
**Depends on:** Phase 167
**Deviation 2026-09-24 (review round 1, WR-05):** KCS-23's "`Delete` behaves as before" was amended — `Delete` on a key that is a member of any composite is refused on every card (a failed membership read refuses too), so a draft composite cannot silently lose its last member. Recorded in `167.2-CONTEXT.md` KCS-23; founder to confirm.

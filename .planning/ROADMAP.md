...
**Plans**: 4 plans in 2 waves
  ...
  - [ ] 25-02-PLAN.md — scenario-share-token.ts (256-bit randomBytes → base64url, sha256 hash-in-Node single source-of-truth) + entropy/format/hash unit test [wave 1]
...
| 25. Read-Only Sharing | 1/4 | In Progress|  |

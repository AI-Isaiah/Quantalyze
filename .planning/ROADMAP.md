...
- [x] 164.5.1-03-PLAN.md — wave 1 · criterion 7: the `ALTER ROLE service_role SET statement_timeout = '45s'` forward migration (`20260916120000`) + a static gate failing in both directions. Schema-push gate ANSWERED by the recorded no-local-push override

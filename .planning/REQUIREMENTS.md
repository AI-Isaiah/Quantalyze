...
| WIZFORM-05 | Phase 153 (v1.17) | **PARTIAL** — 153.3 landed the server half (bounded end-to-end deadline + terminal lease); 153.4-01 minted the client `validate-key-serialized` row at 120 000 ms with `BREAKER_LOCK_TOMBSTONE_S` 60→90 (D-26) and pinned client > the 105 s server worst case. ⚠️ The row is INERT until 153.4-02 lands `budgetKeyFor(exchange)` — every venue still spends 30 000 ms — and D-05's honest long-wait UI is 153.4-03's. Owners: 153.4-02, 153.4-03 |
